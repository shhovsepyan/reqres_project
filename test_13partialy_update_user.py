...
@allure.description("This test case verifies updating a user's information using PATCH method")
@pytest.mark.smoke
def test_update_user():
    ...
    with allure.step("Parse and assert response data"):
        ...
        assert response_data["name"] == "Anna", f"Expected 'name' to be 'Anna', but got {response_data['name']}"

    with allure.step("Print the updated user information"):
        print("Updated user (PATCH):")
